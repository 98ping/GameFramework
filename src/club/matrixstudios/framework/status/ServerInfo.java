...
public class ServerInfo {
    ...
    @Getter private static HashSet<String> hycoreServers = new HashSet<>();
    ...
    public static List<String> getGroups() {
        ...
        StatusProvider.getServerDataTable().column(ServerProperty.GROUP).keySet().stream().filter(s -> !groups.contains(s) && getProperty(s, ServerProperty.GROUP) != null).forEach(groups::add);
        if(groups.isEmpty()) return null;
        return groups;
    }
